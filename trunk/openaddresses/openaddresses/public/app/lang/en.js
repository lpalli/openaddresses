...
OpenLayers.Util.extend(OpenLayers.Lang.en, {
    ...
    'Fill the empty attributes of this address with the value of the previous edited address. For all attributes except house number and house name.':'Fill the empty attributes of this address with the value of the previous edited address. For all attributes except house number and house name.',
    'Get missing values from previous address':'Get missing values from previous address',
    'Get Point':'Get Point',
    'GPS':'GPS',
    ...
    'Ongoing development...<br> About 4.3 millions in OpenAddresses.org.For now, take contact with us through openaddresses[at]googlegroups.com.':'Ongoing development...<br> About 10 millions in OpenAddresses.org.For now, take contact with us through info[at]openaddresses.org',
    'Ongoing development...<br> For now, take contact with us through openaddresses[at]googlegroups.com.':'Ongoing development...<br> For now, take contact with us through info[at]openaddresses.org',
