...
OpenLayers.Util.extend(OpenLayers.Lang.fr, {
    '...still loading layers…':'… couches en cours de chargement…',
    ...
    'Cancel':'Annuler',
    'City':'Ville',
    'Click in the map':'Cliquer sur la carte',
    'Computation ongoing....':'Calcul en cours…',
    'Compute itinerary':'Calculer itinéraire',
    'Country':'Pays',
    'Create':'Créer',
    'Delete':'Effacer',
    ...
    'Fill the empty attributes of this address with the value of the previous edited address. For all attributes except house number and house name.':'Remplir les attributes manquants de cette adress à partie de l\'adresses précédemment enregistrée. Pour tous les attributs à l\'excepton du numéro de bâtiment et du nom de bâtiment',
    'Get missing values from previous address':'Obtenir valeurs de l\'adresse précédente',
    'Get Point':'Digitaliser',
    'GPS':'GPS',
    'House name':'Nom du bâtiment',
    'House number':'No. de bâtiment',
    'License':'Licence',
    'Linear interpolation':'Interpolation linéaire',
    'Ongoing development...<br> About 4.3 millions in OpenAddresses.org.For now, take contact with us through openaddresses[at]googlegroups.com.':'Développement en cours...<br> Environ 10 millions d\'adresses dans OpenAddresses.org. Dans l\'état actuel, prenez contact avec nous en envoyant un email à info[at]openaddresses.org',
    'Ongoing development...<br> For now, take contact with us through openaddresses[at]googlegroups.com.':'Développement en cours...<br> Dans l\'état actuel, prenez contact avec nous en envoyant un email à info[at]openaddresses.org',
    ...
    'Please zoom further to create or edit an address':'Veuillez zoomer davantage pour créer ou éditer une adresse',
    'Position: ':'Coordonnée: ',
    'Postal code':'Code Postal',
    'Powered by MapFish: the web mapping development framework !':'Powered by MapFish: the web mapping development framework !',
    'Project Discussion':'Forum de discussion',
    ...
    'Services':'Services',
    'Several companies:':'Plusieurs entreprises: Camptocamp, Inser, Ubithere',
    'Several universities:':'Plusieurs universités: University of Applied Sciences Northwestern Switzerland (FHNW) et Carinthia University of Applied Sciences (CUAS)',
    ...
    'This project is a joint effort of several persons:':'Ce projet est un travail conjoint de plusieurs personnes: Stefi, Hans-Jörg, Cédric, Jeff, Jean-Luc, Luca, Lukas, Lars, Yves J., Yves ',
    'Total length: ':'Distance total: ',
    'Upload':'Upload',
