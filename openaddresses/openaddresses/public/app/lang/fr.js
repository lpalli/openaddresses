...
OpenLayers.Util.extend(OpenLayers.Lang.fr, {
    ...
    'Get the address from an authorized source':'Obtenir l\'adresse d\'une source de données autorisée.',
    'Get values from authorized source':'Obtenir adresse d\'une source autorisée',
    'GPS':'GPS',
    'House name':'Nom du bâtiment',
    'House number':'No. de bâtiment',
    'If you want to integrate your data in OpenAddresses, please upload them with the following form. If you have several files, create a zip. We\'ll take care of the import. For any questions, please send an email to info [at] openaddresses.org. By uploading data, you accept the terms of use od OpenAddresses.org.':'Si vous voulez intégrer vos données à OpenAddresses, veuillez utiliser le formulaire suivant. Si vous avez plusieurs fichiers, merci de créer un zip. Nous nous occuperons de l\'import de données. Pour toutes questions, vous pouvez envoyer un mail à info[at]openaddresses.org. En uploadant vos données, vous acceptez les conditions d\'utilisations d\'OpenAddresses.org',
    'License':'Licence',
    'Linear interpolation':'Interpolation linéaire',
    'Locality':'Localité',
    'No data found':'Aucune donnée addresse trouvée dans une source de donnée autorisée à la position cliquée.',
    ...
    'Please enter a valid email address and select a file.':'Veullez entrer une adresse valide et choisir un fichier.',
    ...
    'The locality. It is an addition to the city information.':'La localité. C\'est un complément à la ville.',
    ...
    'Upload':'Upload',
    'Uploading file':'Transfert du fichier',
    ...
    'Your file has been uploaded. You will receive a confirmation email. Thanks for your contribution !':'Votre fichier à été transféré. Vous allez recevoir un email de confirmation. Merci pour votre contribution !'
});
