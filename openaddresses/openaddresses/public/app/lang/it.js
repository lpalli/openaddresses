...
OpenLayers.Util.extend(OpenLayers.Lang["it"], {
    '...still loading layers…':'... layers in corso di caricamento ...',
    ...
    'Cancel':'Annulla',
    'City':'Città',
    'Click in the map':'Cliccare sulla mappa',
    'Computation ongoing....':'Calcolo in corso...',
    'Compute itinerary':'Calcolare l\'itinerario',
    'Country':'Paese',
    'Create':'Crea',
    'Delete':'Cancella',
    ...
    'Do you need help ?':'Ha bisogno d\'aiuto ?',
    ...
    'Get Point':'Inserire il punto',
    'GPS':'GPS',
    'House name':'Nome dell\'edificio',
    'House number':'Numero dell\'edificio',
    'License':'Licenza',
    'Linear interpolation':'Interpolazione lineare',
    'Ongoing development...<br> About 4.3 millions in OpenAddresses.org.For now, take contact with us through openaddresses[at]googlegroups.com.':'Sviluppo in corso...<br> Circa 10 milioni in OpenAddesses.org. Per il momento, contattateci via info[at]openaddresses.org',
    'Ongoing development...<br> For now, take contact with us through openaddresses[at]googlegroups.com.':'Sviluppo in corso...<br> Per il momento, contattateci via info[at]openaddresses.org',
    'OpenAddresses':'OpenAddresses',
    'OpenAddresses Code Licence':'Licenza del codice di OpenAddresses',
    'OpenAddresses Data Licence':'Licenza dei dati di OpenAddresses',
    'OpenAddresses is a web portail for the management of Open Source worldwide localized postal addresses.':'OpenAddresses è un portale web per la gestione libera delgi indirizzi postali su scala mondiale.',
    'Overlay opacity':'Opacità delle sovrapposizione',
    'Permalink':'Indirizzo',
    ...
    'Project Discussion':'Forum di discussione',
    ...
    'Services':'Servizi',
    'Several companies:':'Diverse imprese: Camptocamp, Inser, Ubithere',
    'Several universities:':'Diverse università: University of Applied Sciences Northwestern Switzerland (FHNW) e Carinthia University of Applied Sciences (CUAS)',
    ...
    'This project is a joint effort of several persons:':'Questo progetto è il lavoro collaborativo di diverse persone: Stefi, Hans-Jörg, Cédric, Jeff, Jean-Luc, Luca, Lukas, Lars, Yves J., Yves ',
    'Total length: ':'Distanza totale',
    'Upload':'Carica',
    'User Validation':'Verifica dell\'utente',
    'Username':'Nome utente',
    'Welcome in OpenAddresses':'Benvenuto in OpenAddresses',
    'WGS84':'WGS84',
